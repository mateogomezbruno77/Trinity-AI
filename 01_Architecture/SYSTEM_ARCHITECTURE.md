...
Cada módulo utiliza al anterior.

Ningún módulo debe duplicar responsabilidades.

---

# Flujo de una solicitud

Cuando un usuario realiza una solicitud, Trinity AI sigue el siguiente recorrido:

1. Comprender la solicitud.
2. Aplicar las reglas de Foundation.
3. Consultar CORE.
4. Determinar el Framework adecuado.
5. Buscar conocimiento relevante.
6. Seleccionar el SOP correspondiente.
7. Asignar el agente responsable.
8. Ejecutar integraciones necesarias.
9. Activar automatizaciones si corresponde.
10. Generar una respuesta accionable.
